        """
        Excel Transformer K8phymk
        =========================
        Schema-aware processor designed to export raw data into clean outputs.
...
from pathlib import Path
        ...
        APP_NAME    = "Excel Transformer K8phymk"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Schema-aware processor designed to export raw data into clean outputs.")
